...
document.getElementById("label-3").innerHTML = "Sketch To Be Drawn: " + Element_of_array;
...
function check_sketch() {
    ...
    if (timer_counter > 500) {
        document.getElementById("label-1").innerHTML = "Your Sketch: ";
        document.getElementById("label-2").innerHTML = "Confidence: ";
        timer_counter = 0;
...
function updateCanvas() {
    ...
    sketch = element_of_array;
    document.getElementById("label-3").innerHTML = "Sketch To Be Drawn: " + sketch;
}
...
function gotResults(error, results) {
    ...
    document.getElementById("label-1").innerHTML = "Your Sketch: " + results[0].label;
    document.getElementById("label-2").innerHTML = "Confidence: " + Math.round(results[0].confidence * 100) + "%";
}
